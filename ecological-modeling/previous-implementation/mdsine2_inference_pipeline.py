...
# Usage: python3 mdsine2_inference_pipeline.py [dataset] [seed]
...
sys.stdout = open(f"{basepath}/{dataset}_seed{seed}_inference.log", "wt")
...
### Load the infered Negative Binomial dispersion parameters ###
print('Load the infered Negative Binomial dispersion parameters')
mcmc_negbin = pd.read_pickle(f'{negbin_dir}/mcmc.pkl')

# Set a0 and a1 from negbin (get the mean of the posterior) and fixes them for inference
print('Set the dispersion parameters')
