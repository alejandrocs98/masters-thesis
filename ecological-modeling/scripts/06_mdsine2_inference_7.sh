...
#SBATCH --job-name=06_mdsine2_inference_noD_7
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 4
...
#SBATCH --array=1-4%4
#SBATCH -o logs/06_mdsine2_inference_noD_7.o%j

source ~/anaconda3/bin/activate
conda activate mdsine2

set $(sed -n ${SLURM_ARRAY_TASK_ID}p /hpcfs/home/ciencias_biologicas/a.castellanoss/masters-thesis/scripts/06_mdsine2_inference_lookupfile_7.txt)
dataset=$1
seed=$2
