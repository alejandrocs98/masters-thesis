...
#SBATCH --job-name=08_mdsine2_forward_simulate_noD_3
#SBATCH -p short
#SBATCH -N 1
#SBATCH -n 1
...
#SBATCH --array=1-135%10
#SBATCH -o logs/08_mdsine2_forward_simulate_noD_3.o%j

source ~/anaconda3/bin/activate
conda activate mdsine2

set $(sed -n ${SLURM_ARRAY_TASK_ID}p /hpcfs/home/ciencias_biologicas/a.castellanoss/masters-thesis/scripts/08_mdsine2_forward_simulate_lookupfile_3.txt);
dataset=$1
seed=$2
subject=$3
