...
#SBATCH --job-name=09_mdsine2_visualize_forward_sims_noD
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 1
...
#SBATCH -o logs/09_mdsine2_visualize_forward_sims_noD.o%j
...
set $(sed -n ${SLURM_ARRAY_TASK_ID}p /hpcfs/home/ciencias_biologicas/a.castellanoss/masters-thesis/scripts/09_mdsine2_visualize_forward_sims_lookupfile.txt)
simtype=$1
dataset=$2
seed=$3
