...
#SBATCH --job-name=09_mdsine2_forward_simulate
#SBATCH -p medium
#SBATCH -N 1
#SBATCH -n 1
...
#SBATCH -o logs/09_mdsine2_forward_simulate.o%j

source ~/anaconda3/bin/activate
conda activate mdsine2

set $(sed -n ${SLURM_ARRAY_TASK_ID}p /hpcfs/home/ciencias_biologicas/a.castellanoss/masters-thesis/scripts/09_mdsine2_forward_simulate_lookupfile.txt);
dataset=$1
seed=$2
subject=$3
