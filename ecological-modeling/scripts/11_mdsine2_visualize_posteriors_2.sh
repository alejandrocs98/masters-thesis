...
#SBATCH --job-name=11_mdsine2_visualize_posteriors_noD_2
#SBATCH -p short
#SBATCH -N 1
#SBATCH -n 1
...
#SBATCH --array=1-6%6
#SBATCH -o logs/11_mdsine2_visualize_posteriors_noD_2.o%j
...
set $(sed -n ${SLURM_ARRAY_TASK_ID}p /hpcfs/home/ciencias_biologicas/a.castellanoss/masters-thesis/scripts/11_mdsine2_visualize_posteriors_lookupfile_2.txt)
dataset=$1
